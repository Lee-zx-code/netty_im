package com.im.imClient.clientBuilder;

import com.im.common.bean.UserDTO;
import com.im.imClient.client.ClientSession;
...
public class LoginMsgBuilder extends BaseBuilder {
    ...
    public ProtoMsg.Message build() {
        ...
        ProtoMsg.LoginRequest.Builder lb = ProtoMsg.LoginRequest.newBuilder().setDeviceId(user.getDevId()).setPlatform(user.getPlatform().ordinal()).setToken(user.getToken()).setUid(user.getUserId());
